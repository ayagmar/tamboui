...
public interface RenderContext {
     ...
     * (e.g., for a RichList rendering, "item" becomes "RichList-item").
     * <p>
     * Example usage:
     * <pre>{@code
     ...
     * RichList-item:selected { color: cyan; text-style: bold; }
     * #nav RichList RichList-item:selected { color: green; }
     * }</pre>
     *
